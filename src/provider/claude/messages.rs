...
impl MessagesResponse {
    ...
    /// 停止理由を FinishReason に変換
    pub fn finish_reason(&self) -> Option<crate::provider::FinishReason> {
        self.stop_reason.as_ref().map(|reason| match reason.as_str() {
            "end_turn" => crate::provider::FinishReason::EndTurn,
            "max_tokens" => crate::provider::FinishReason::MaxTokens,
            "stop_sequence" => crate::provider::FinishReason::StopSequence,
            "tool_use" => crate::provider::FinishReason::ToolUse,
