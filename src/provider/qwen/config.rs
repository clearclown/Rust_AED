...
/// DashScope API のデフォルト URL
pub const DEFAULT_DASHSCOPE_API_URL: &str =
...
fn default_base_url() -> String {
    DEFAULT_DASHSCOPE_API_URL.to_string()
}
...
impl QwenConfig {
    ...
    pub fn from_env() -> Self {
        ...
        let base_url = std::env::var("DASHSCOPE_BASE_URL")
            .unwrap_or_else(|_| DEFAULT_DASHSCOPE_API_URL.to_string());
